...
float tamt;
//login class used for login for both as a admin and user
class login
{
public:
    char id[100];
...
//Detail class used to get details about train and display details about train
class Detail
{
public:
    int tno;
...
//reservation class used for reserve a ticket
class reservation
{
public:
    int pnr;
...
//cancellation class used for cancell a ticket reservartion
class cancellation
{
public:
    int pnr;
